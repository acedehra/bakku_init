        ...
        <div className="p-6 space-y-8">
          ...
          <section>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Export your collections, environments, and request history, or import data from a
              file.
            </p>
              ...
              <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <button
                    ...
                    onClick={() => handleExport(exportAll)}
                  ...
                  <button
                    disabled={isExporting}
                    onClick={() => handleExport(exportCollections)}
                    className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-secondary text-secondary-foreground rounded-md hover:bg-secondary/80 transition-colors disabled:opacity-50"
                  >
                    <Download className="h-4 w-4" />
                    Export Collections
                  </button>
                  <button
                    disabled={isExporting}
                    onClick={() => handleExport(exportEnvironments)}
                    className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-secondary text-secondary-foreground rounded-md hover:bg-secondary/80 transition-colors disabled:opacity-50"
                  >
                    <Download className="h-4 w-4" />
                    Export Environments
                  ...
                  <button
                    disabled={isExporting}
                    onClick={() => handleExport(exportHistory)}
                    className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-secondary text-secondary-foreground rounded-md hover:bg-secondary/80 transition-colors disabled:opacity-50"
                  >
                    <Download className="h-4 w-4" />
                    Export History
