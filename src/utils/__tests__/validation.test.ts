...
describe('validation', () => {
  ...
  describe('validateParams', () => {
    ...
    it('should skip empty param keys', () => {
      const result = validateParams([{ id: '1', key: '', value: 'value', enabled: true }]);
  ...
  describe('validateEnvironment', () => {
    ...
    it('should accept valid environment', () => {
      const result = validateEnvironment({
        id: '1',
        name: 'Production',
        variables: [{ key: 'API_URL', value: 'https://api.example.com', enabled: true }],
      });
      expect(result.isValid).toBe(true);
    });
    ...
    it('should validate variables', () => {
      const result = validateEnvironment({
        id: '1',
        name: 'Production',
        variables: [{ key: '', value: 'value', enabled: true }],
      });
      expect(result.isValid).toBe(false);
    });
  });
