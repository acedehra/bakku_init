...
describe('urlParser', () => {
  ...
  describe('getBaseUrl', () => {
    ...
    it('should return input for URL without query params and no protocol', () => {
      expect(getBaseUrl('https://api.example.com/users')).toBe('https://api.example.com/users');
    });
    ...
    it('should strip query params from URL without protocol', () => {
      expect(getBaseUrl('api.example.com/users?page=1')).toBe('api.example.com/users');
    });
  ...
  describe('parseUrlParams', () => {
    ...
    it('should parse multiple query params', () => {
      const result = parseUrlParams('https://example.com?key1=value1&key2=value2');
    ...
    it('should decode URL-encoded values', () => {
      const result = parseUrlParams('https://example.com?name=John%20Doe&email=test%40example.com');
    ...
    it('should handle special characters in keys', () => {
      const result = parseUrlParams('https://example.com?user%5Bname%5D=John&user%5Bage%5D=30');
      expect(result).toEqual({
        'user[name]': 'John',
        'user[age]': '30',
      });
  ...
  describe('buildUrlWithParams', () => {
    ...
    it('should encode keys and values', () => {
      ...
      expect(result).toBe('https://example.com?name=John%20Doe&email=test%40example.com');
    });
    ...
    it('should handle URL that already has query params', () => {
      const result = buildUrlWithParams('https://example.com?existing=value', { new: 'param' });
    ...
    it('should handle special characters in keys', () => {
      ...
      expect(result).toBe('https://example.com?user%5Bname%5D=John&user%5Bage%5D=30');
    });
  });
